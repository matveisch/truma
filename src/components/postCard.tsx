          ...
          {phones.map((phone, index) => {
            ...
            return (
              <div className="flex gap-2" key={index}>
                ...
                <a
                  target="_blank"
                  href={'https://api.whatsapp.com/send?phone=' + phoneLink.slice(1)}
                  style={{ direction: 'ltr' }}
                  className=" w-full flex items-center justify-center gap-1 border-2 p-2 color-slate-400 rounded-md hover:bg-green-100"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <a
                  target="_blank"
                  href={'https://t.me/' + phoneLink}
                  style={{ direction: 'ltr' }}
                  className=" w-full flex items-center justify-center gap-1 border-2 p-2 color-slate-400 rounded-md hover:bg-blue-100"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
